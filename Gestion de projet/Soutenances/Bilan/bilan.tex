...
\subsection{Task list} % TODO traduire
	\begin{frame}{\subsecname}
		\begin{center}
		{\renewcommand{\arraystretch}{1.3}
		\begin{tabular}{|m{4.5cm}<{\centering}c|m{4.5cm}<{\centering}c|}
			\hline
			\multicolumn{3}{|c}{1 - Documentation, test et aide utilisateur} & \Valid\\
			\hline
			...
			\hline
			8 - Dessin \`a main levée m\'eridienne & \Valid & 7 - Am\'elioration IHM Param\`etres & \Valid\\
			\hline
			9 - Gestion des donn\'ees & \Valid & 10 - Am\'elioration IHM \linebreak Rentrer des formules & \Valid\\
			\hline
			\multicolumn{3}{|c}{11 - Ajout courbes utilisateur} & \NotCheck\\
			\hline
			\multicolumn{3}{|c}{12 - R\'edaction rapport technique} & \Valid\\
			\hline
		\end{tabular}}
		\end{center}
	\end{frame}
...
% --- Livrables ----------------------------------------------------------------
	...
	\begin{frame}{\subsecname}
		...
		\begin{tabular}{|c|m{5.5cm}|c|c|}
			...
			\hline % TODO traduire 2bis et 5bis au moins
		\end{tabular}}
		\end{center}
	\end{frame}
...
\subsection{Quality insurance plan}
	% TODO le remettre traduis et plus précis
	\begin{frame}{\subsecname}
		\begin{columns}
			\begin{column}{8cm}
				\begin{figure}
	...
	\begin{frame}{Software quality evaluation}
		\begin{figure}
			\includegraphics[width=12cm]{Images/resultat_qualite.jpg}
		...
		\begin{exampleblock}{Q.I.P Reviews}
			...
			\begin{enumerate}
				% TODO ne pas mettre des phrases
				\item The use of such techniques for explicitly and analyzing such quality during  the requirements phases 
...
\subsection{Costs}
	\begin{frame}{\subsecname}
		\begin{figure}
			\caption{\todo{regénéré cette image}}
