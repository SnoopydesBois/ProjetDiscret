...
\subsection{Quality insurance plan}
	...
	\end{frame}
		...
		\begin{frame}{\subsecname}
			\frametitle{Software quality measurment}
			
			\begin{columns}
				\begin{column}{8cm}
					\begin{figure}
		\includegraphics[width=6cm]{Images/ergonomie.jpg}
					\end{figure}
						\begin{figure}
		\includegraphics[width=7cm]{Images/fonctionality.jpg}
						\end{figure}
				\end{column}
	...
	\begin{frame}{\subsecname}
					\frametitle{Software quality evaluation}
					\begin{figure}
