...
\@ifpackageloaded{pifont}{
	...
	\newcommand{\Added}{{\color{RoyalBlue}\,\ding{58}}} % + gras
...
\makeatletter
\@ifpackageloaded{pifont}{
	\newcommand{\Proven}{{\color{BrickRed}\ding{55}}} % X
	\newcommand{\Initial}{{\color{ForestGreen}\ding{56}}}
	\newcommand{\NewRisk}{{\color{RoyalBlue}\,\ding{58}}} % + gras
}{
	\newcommand{\Proven}{{\color{BrickRed}\textbf{!}}}
	\newcommand{\Initial}{{\color{ForestGreen}*}}
	\newcommand{\NewRisk}{{\color{RoyalBlue}+}}
}
\makeatother
