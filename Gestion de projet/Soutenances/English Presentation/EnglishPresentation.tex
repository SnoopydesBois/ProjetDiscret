	...
	\begin{frame}{\subsecname}
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item First meeting : around December 20th of 2015
...
% --- Livrables ----------------------------------------------------------------
	...
	\begin{frame}{\subsecname}
		...
		\begin{tabular}{|c|m{6.5cm}|c|} % FIXME relier les livrables au tâches
			...
			\hline
			3 & Hand Free drawing and curves with editable parameters & 01/29\\
			\hline
	...
	\begin{frame}{\subsecname}
		List of identified risks~:
			\begin{itemize}
				...
				\item Interface to develop for two types of users (1)
...
% FIXME ne pas oublier les solution (préventives et curatives) au moins à l'oral
	...
	\begin{frame}{\subsecname}
		\begin{itemize}
			\item Interface to develop for two types of users
		\end{itemize}
		\begin{figure}
			...
			\item Quality insurance plan
				\begin{itemize}
					\item QIP~: ISO-9126 standard
 					\item a rating is given depending on the criteria
...
% --- Tests --------------------------------------------------------------------
	...
	\begin{frame}{\subsecname}
		...
		\begin{block}{External tests}
			\begin{itemize}
				\item Application validation by the clients and the quality manager
				\begin{itemize}
					\item Functionalities validation
					\item Interface validation
				\end{itemize}
				\item Formula Tests scripts are given to the clients
			\end{itemize}
		\end{block}
	\end{frame}
...
\begin{frame}{\secname}
	\begin{itemize}
		\item Project cost~:
			\begin{itemize}
				\item Young engineer~: 3 000 \Euro{} / month
