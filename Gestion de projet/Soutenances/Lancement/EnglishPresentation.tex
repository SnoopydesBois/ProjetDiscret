...
% --- Taches -------------------------------------------------------------------
	...
	\begin{frame}{\subsecname}
		...
		\begin{tabularx}{11cm}{|>{\hfill}X<{\hspace*{\fill}}|X<{\centering}|}
			\hline
			\multicolumn{2}{|c|}{1 - Documentation, test and users help}\\
			\hline
			\multicolumn{2}{|c|}{2 - Design}\\
			\hline
			3 - Kernel functional & 4 - Minimal interface\\
			\hline
			6 - Fonctionnalies adding & \multirow{3}*{5, 7, 10 - IHM enhancement}\\
			\cline{1-1}
			8 - Free hand curve & \\
			\cline{1-1}
			9 - Data management & \\
			\hline
			\multicolumn{2}{|c|}{11 - User's curve}\\
			\hline
			\multicolumn{2}{|c|}{12 - Technical report}\\
			\hline
		\end{tabularx}}
		\end{center}
	\end{frame}
...
% --- Gantt --------------------------------------------------------------------
	...
	\begin{frame}{Gantt}
		\begin{figure}
			\includegraphics[width=12cm]{../Images/gantt_zoom_noyau.png}
		\end{figure}
	\end{frame}
...
% --- Avancement ---------------------------------------------------------------
	...
	\begin{frame}{\subsecname}
		\begin{figure}
			\includegraphics[width=12cm]{ImagesLancement/Avancement.png}
		\end{figure}
	\end{frame}
...
% --- Risques ------------------------------------------------------------------
	...
	\begin{frame}{\subsecname}
		List of identified risks:
			\begin{itemize}
				\item Generation algorithm evolution (criticality: 2)
...
% FIXME ne pas oublier les solution (préventives et curatives) au moins à l'oral
	\begin{frame}{\subsecname}
		...
		\end{figure}
		\begin{figure}
			\includegraphics[height=2cm]{ImagesLancement/legende_risque2.png}
		\end{figure}
	\end{frame}
...
% --- Tests --------------------------------------------------------------------
	...
	\begin{frame}{\subsecname}
		\begin{figure}
			\includegraphics[height=8cm]{ImagesLancement/PAQL.png}
		\end{figure}
	\end{frame}
...
%\begin{frame}{\secname}
%	\begin{figure}
%		\includegraphics[width=12cm]{ImagesLancement/Cout2.png}
%	\end{figure}
%\end{frame}
...
\begin{frame}{\secname}
	\begin{itemize}
		\item Cycles organization $\to$ incremental development
		\item Validation with the clients
