...
% --- Taches -------------------------------------------------------------------
	\subsection{T\^aches} % FIXME Checked or not
	\begin{frame}{\subsecname}
		\begin{center}
...
% --- Zoom Gantt Initial --------------------------------------------------------------------
	\begin{frame}{Gantt (zoom)}
		...
		% FIXME image directe si possible
		\begin{center}
			...
			% FIXME 
			% 3.3 à 100%
			% clip espace superflue
		\end{center}
	\end{frame}
	
% FIXME fusioné les deux frame
	
% --- Gantt --------------------------------------------------------------------
	\subsection{Gantt de suivi}
	\begin{frame}{\subsecname}
		\begin{center}
			% TODO coupé au dessus du 6 (gardé le dessous)
...
% --- Livrables ----------------------------------------------------------------
	...
	\begin{frame}{\subsecname}
		\begin{center}
		\small
		\begin{tabular}{|c|>{\raggedright}m{3cm}|c|c|c|} % FIXME relié les livrables au tâches
			\hline
...
% --- Risque -------------------------------------------------------------------
	\begin{frame}{\secname}
		...
		\end{itemize}
		\begin{figure}
		% FIXME proba à 0 et enlevé gris
...
% --- Risque -------------------------------------------------------------------
	\begin{frame}{\secname}
		...
		\end{itemize}
		\begin{figure}
			\includegraphics[width=8cm]{risque_nouveau_client.png} % FIXME flèche
		\end{figure}
		\begin{center}
			\legendeRisque
		\end{center}
...
% --- Évaluation ---------------------------------------------------------------
	\begin{frame}{\secname}
		...
		\end{itemize}
		\begin{figure}
			\includegraphics[width=8cm]{Images/QualiteInterneExterne.png} % FIXME nouvelle image
		\end{figure}
	\end{frame}
...
% --- Évaluation ---------------------------------------------------------------
	\begin{frame}{\secname}
		...
		\end{itemize}
		\begin{figure}
			\includegraphics[width=8cm]{Images/QualiteLogicielle.png} % FIXME nouvelle image
		\end{figure}
	\end{frame}
...
% --- Évaluation ---------------------------------------------------------------
	\begin{frame}{\secname}
		...
		\end{itemize}
		\begin{figure}
			\includegraphics[width=8cm]{Images/EvaluationCriteres.png} % FIXME nouvelle image
		\end{figure}
	\end{frame}
...
\begin{frame}{Diagramme des co\^uts}
	\begin{figure}
		\includegraphics[height=3.8cm]{Images/CourbeCout.png} % FIXME à refaire
	\end{figure}
\end{frame}
