...
% --- Taches -------------------------------------------------------------------
	...
	\begin{frame}{\subsecname}
		...
		\begin{tabularx}{11cm}{|>{\hfill}X<{\hspace*{\fill}}|X<{\centering}|} % --FIX ME--
			\hline
...
% Faire tenir les zoom sur la même diapo pour comparer?
% Peut-être problème d'accent sur les nom de fichiers
...
% --- Gantt --------------------------------------------------------------------
	...
	\begin{frame}{Gantt}
		...
		% \begin{figure}
			% \includegraphics[width=8cm]{Images/Gantt_ProjetDiscret.gif}
		% \end{figure}
...
% --- Zoom Gantt Initial --------------------------------------------------------------------
	...
	\begin{frame}{Gantt}
		...
		% \begin{figure}
			% \includegraphics[width=8cm]{Images/GantInitialClasses.gif}
		% \end{figure}
...
% --- Gantt --------------------------------------------------------------------
	...
	\begin{frame}{Gantt}
		...
		% \begin{figure}
			% \includegraphics[width=8cm]{Images/Gantt_ProjetDiscretRéférence.gif}
		% \end{figure}
...
% --- Zoom Gantt Révisé --------------------------------------------------------------------
	...
	\begin{frame}{Gantt}
		...
		% \begin{figure}
			% \includegraphics[width=8cm]{Images/GantReferenceClasses.gif}
		% \end{figure}
...
\begin{frame}{\secname}
	...
	\hspace{1cm}\=\hspace{2cm}\=\kill
		Retard pris toujours pr\'esent % Encore un hspace après?
		Prochaines \'etapes\\
